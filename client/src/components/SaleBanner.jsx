...
const SaleBanner = () => {
  return (
    <section className="w-full bg-[#c0d3e5] flex flex-col md:flex-row items-center justify-between overflow-hidden h-auto md:h-[500px] mb-20">
      ...
      {/* Center Text Content */}
      <div className="w-full md:w-1/3 flex flex-col items-center justify-center text-center py-12 md:py-0 px-4">
        {/* Top Pill */}
